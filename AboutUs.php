...
<div id="logo" class="container">
	<h1><a href="index.php" class="icon icon-spinner"><span>Vijay Cricket Club</span></a></h1>
</div>
<div id="header">
	<div id="menu" class="container">
		<ul>
			...
			<li><a href="teams.php" accesskey="2" title="">Teams</a></li>
			...
			<li><a href="results.php" accesskey="4" title="">Login</a></li>
			<li><a href="results.php" accesskey="4" title="">Sign Up</a></li>
		</ul>
	</div>
</div>
<div id="page-wrapper">
	<!--<div id="banner" class="container"><a href="#"><img src="images/CricketBall.jpg" width="1200" height="300" alt="" /></a></div>-->
	<div id="featured" class="container">
		<div class="box">
			<div class="title">
				<h2>About Us</h2>
			</div>
			<p>Vijay Cricket Club is One of the best cricket club of central India from year 2000, established in year 1958 at Indore (Madhya Pradesh).Our Club started his progress in the year 1958 & has now become the no. 1 Cricket club in Indore.
The players of the club has achieved great results under the guidance and coaching of Mr. Subodh Jain Sir(Former Ranji Trophy Player) and the soul and founder of the Club Mr. Ramji Atre Sir......
The guidance of our coach has created the hunger of winning every matches at the Club level...Our Club plays every match as it is a Final..
Our Club has given many talented and promising Cricketers at the Senior level under the guidance of Mr. Subodh Jain Sir like Mr. Sachin Dholpure,Sunil Dholpure,Amal Kokje,Jitendra Likhar,Madhav Saxena,Shantanu Pitre,Gaurav Kshirsagar who represents State team for many years and has lead the MP team successfully in every situation...Mr. Sachin Dholpure & Amal Kokje has also represents U-19 India...
Our club has also given emerging players in the name of Rajat Patidar,Saransh Jain & Abhishek Pathrod who are shining at the U-22 & U-19 State team level.....!!!</p>
		</div>
